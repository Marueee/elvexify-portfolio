          ...
          <div className="max-w-sm">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-hairline text-ink-soft transition-colors hover:border-electric/60 hover:text-white"
              >
            ...
            <ul className="mt-5 space-y-3">
              ...
              <li className="pt-2">
                <a
                  ...
                  className="text-sm font-medium text-electric-bright transition-colors hover:text-white"
                >
                  {SITE.email}
                </a>
              </li>
